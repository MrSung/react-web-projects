...
function UidToDo1({ storeUidToDo = store }) {
  ...
  return (
    <div>
      <h1>{heading.uidToDo1}</h1>
      <Todos todos={todosUidToDo1} store={storeUidToDo} />
      <Goals goals={goalsUidToDo1} store={storeUidToDo} />
    </div>
  );
}
